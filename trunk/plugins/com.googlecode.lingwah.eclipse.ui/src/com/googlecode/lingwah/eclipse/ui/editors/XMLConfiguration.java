...
public class XMLConfiguration extends SourceViewerConfiguration {
	...
	public String[] getConfiguredContentTypes(ISourceViewer sourceViewer) {
		return new String[] {
			...
			LingwahPartitionScanner.XML_COMMENT,
			LingwahPartitionScanner.XML_TAG };
	}
	...
	protected XMLScanner getXMLScanner() {
		if (scanner == null) {
			...
			scanner.setDefaultReturnToken(
				new Token(
					new TextAttribute(
						colorManager.getColor(LingwahColorConstants.DEFAULT))));
		}
		return scanner;
	}
	protected XMLTagScanner getXMLTagScanner() {
		if (tagScanner == null) {
			...
			tagScanner.setDefaultReturnToken(
				new Token(
					new TextAttribute(
						colorManager.getColor(LingwahColorConstants.TAG))));
		}
		return tagScanner;
	}
	...
	public IPresentationReconciler getPresentationReconciler(ISourceViewer sourceViewer) {
		...
		NonRuleBasedDamagerRepairer ndr =
			new NonRuleBasedDamagerRepairer(
				new TextAttribute(
					colorManager.getColor(LingwahColorConstants.XML_COMMENT)));
